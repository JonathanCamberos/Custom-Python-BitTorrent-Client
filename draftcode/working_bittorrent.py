...
def initialize_client_state_list():
    ...
    for p in peers:
        ...
        #if p.peer_ip_addr == "128.8.126.63" and p.peer_port == 54545:
...
if __name__ == '__main__':
    ...
    while True:
        if not is_finished and set(my_bitfield_lst) == set(range(num_pieces)):
            is_finished = True
            print("! Finished wohoooooooooo!")


        # with open("./testing/test_write_file", "r") as f:
        #     file_len = len(f.readlines())
        # print("tracker_len = ", tracker.len)
        # print("bytes_recv = ", bytes_recv)
        # print("! file_len = ", file_len)
        # if file_len == tracker.len:
        #     print("! Finished!")
